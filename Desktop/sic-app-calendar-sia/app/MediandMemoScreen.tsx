...
//       // 오늘 날짜 데이터 찾기
//       const todayDataIndex = parsedData.findIndex(
...
//               <TouchableOpacity
//                 key={
//                   memo.id !== undefined ? memo.id.toString() : index.toString()
//                 }
...
//               <TouchableOpacity
//                 key={med.id ? med.id.toString() : 'med_${index}'}
...
//             <TouchableOpacity
//               onPress={closeModal}
//               style={[styles.closeButton, { backgroundColor: '#FFA500' }]}
//             >
//               <Text style={styles.closeButtonText}>닫기</Text>
//             </TouchableOpacity>
//           </View>
