      ...
      >
        {isImageModalVisible ? (
          <View style={styles.imageModalContent}>
            ...
            <TouchableOpacity style={styles.imageModalOption} onPress={pickImageFromGallery}>
              <Text style={styles.imageModalOptionText}>앨범에서 사진 선택</Text>
            </TouchableOpacity>
            <View style={styles.separator} />
            <TouchableOpacity style={styles.imageModalOption} onPress={resetToDefaultImage}>
              <Text style={styles.imageModalOptionText}>기본 이미지로 변경</Text>
            </TouchableOpacity>
            <View style={styles.separator} />
            <TouchableOpacity style={styles.imageModalOption} onPress={toggleImageModal}>
              <Text style={[styles.imageModalOptionText, { color: '#1E90FF' }]}>닫기</Text>
            </TouchableOpacity>
          </View>
        ) : (
