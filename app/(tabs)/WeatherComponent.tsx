...
//     if (temp >= 33)
//       return {
//         message: '날씨가 너무 더우니 외출을 자제해주세요.',
//         icon: require('../../assets/images/temperature.png'),
//       };
//     if (condition === 'Rain')
//       return {
//         message: '비가 오고 있으니 우산을 준비해주세요.',
//         icon: require('../../assets/images/umbrella.png'),
//       };
//     if (condition === 'Snow' || temp < 0)
//       return {
//         message: '날씨가 너무 추우니 옷을 따뜻하게 입어주세요.',
//         icon: require('../../assets/images/muffler.png'),
//       };
//     if (pm10 > 80)
//       return {
//         message: '미세먼지 농도가 좋지 않으니 마스크를 착용해주세요.',
//         icon: require('../../assets/images/mask.png'),
//       };
...
//           date.getMonth() + 1
//         }월 ${date.getDate()}일`;
//         const dayOfWeek = getShortDayOfWeek(
...
//   const preparedness = getPreparednessMessage(
//     weather.temp,
//     weather.condition,
//     weather.pm10
//   );
...
//           <Text
//             style={{
//               color: getDayOfWeekColor(weather.dayOfWeek, weather.date),
//             }}
//           >
//             ({weather.dayOfWeek})
//           </Text>
...
//             <Text style={styles.preparednessMessage}>
//               {preparedness.message}
//             </Text>
//             {preparedness.icon && (
//               <Image
//                 source={preparedness.icon}
//                 style={styles.preparednessIcon}
//               />
//             )}
//           </View>
//         )}
...
const WeatherComponent: React.FC = () => {
  ...
  const getPreparednessMessage = (
    ...
    if (pm10 > 80)
      return {
        message: '미세먼지 농도가 나쁘니 마스크를 착용해주세요!',
        icon: require('../../assets/images/mask.png'),
      };
    return { message: '', icon: null };
  };
